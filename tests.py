import unittest
from piglatin import pig_latin_word, first_vowel_index, pig_latin_sentence
...
class TestPigLatin(unittest.TestCase):
	...
	def test_pig_latin_sentence(self):
		...
		self.assertEqual(pig_latin_sentence('And God said, "Let there be light," and there was light.') , 'Andway Odgay aidsay, "Etlay erethay ebay ightlay," andway erethay asway ightlay.')
